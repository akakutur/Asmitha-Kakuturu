...
public class FileHandle
{
	...
	{
		File dir = new File("C:\\Users\\User\\Desktop\\Virtual");
...
//code for Add file in the folder
	...
	{
		Path pathToFile = Paths.get("C:\\Users\\User\\Desktop\\Virtual\\" +fileToAdd);
	...
	public static void openFile(String sname)
	{
		...
		{
			// path of the folder
			File fdir = new File("C:\\Users\\User\\Desktop\\Virtual"); //path 
			if(fdir.isDirectory())
			{
	...
	public static void deleteFile(String fileToDelete,Scanner sc) throws InvalidFileException
	{
		...
		File f= new File("C:\\Users\\User\\Desktop\\Virtual\\"+fileToDelete);           //file to be delete  
